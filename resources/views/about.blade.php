...
<body>
    <div class="container">
        ...
        <section class="section" data-aos="fade-left">
            <div class="text-item">
                <h2>History</h2>
                <p>PT. Taska Sarana Nusantara merupakan perusahaan yang dibentuk untuk memanfaatkan peluang di bidang
                    ...
                    menyediakan layanan akses internet berkualitas sejak tahun 2024.</p>
                <p>Berdomisili di Jl. Baru Cisinga, Kp. Langkob Girang Rt. 003 Rw 001, Desa Karangresik, Kecamatan Jamanis, Kabupaten Tasikmalaya, Provinsi Jawa Barat (46175).</p>
            </div>
            <div class="image-item">
                <img src="img/histori.jpg" alt="Image of PT. Taska Sarana Nusantara Office">
            </div>
        </section>
        ...
        <section class="section" data-aos="fade-right">
            ...
            <div class="text-item">
                ...
                <p><strong>Vision:</strong> Memberdayakan organisasi dan individu melalui layanan serta solusi terbaik terkait
                    jaringan kabel dan nirkabel.</p>
